    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <form id="form_add" action="<?= base_url("transaksi/donasi/tambah_proses") ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row col-md-12 p-0">
                                <div class="col-md-6">
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <select class="form-control select2bs4" name="id_rekening" id="id_rekening">
                                            <?php foreach ($rekening as $r) : ?>
                                                <option value="<?= $r["id"] ?>"><?= $r["no_rekening"] . " (" . $r["nama_bank"] . " a.n " . $r["atas_nama"] . ")" ?></option>
                                            <?php endforeach; ?>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <input type="number" class="form-control" name="nominal" id="nominal" placeholder="Masukan nominal donasi. Contoh : 1000000">
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <label for="">Keterangan</label>
                                        <textarea id="keterangan" name="keterangan" class="form-control" rows="5" placeholder="Masukan Catatan (opsional)"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <img id="imgPreview" src="<?= asset("apotek/img/no-img.jpg") ?>" class="col-md-12" alt="">
                                            <div class="form-group">
...
<script>
    $("#form_add").submit(e => {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url("transaksi/donasi/tambah_proses") ?>",
            data: formData,
            dataType: 'JSON',
            async: false,
            cache: false,
            ...
            success: function(result) {
                ...
                if (result.code == 200) {
                    Swal.fire({
                        ...
                        .then((result) => {
                            window.location.href = "<?= base_url('transaksi/donasi/tambah') ?>";
                        })
                } else {
                    Swal.fire(
                        'Gagal',
