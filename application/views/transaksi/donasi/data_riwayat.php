        ...
        "columns": [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    tombol += `<a ${disabled} href="<?= base_url("transaksi/donasi/edit/") ?>${data}" type="button" title="Edit" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label text-white"><i class="fas fa-edit"></i></span></a>&nbsp;`
