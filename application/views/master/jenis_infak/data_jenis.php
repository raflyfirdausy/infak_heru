            ...
            <form method="POST" action="<?= base_url("master/$module/add") ?>" id="form_add" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="recipient-name" class="control-label">Nama Jenis Infak <span class="text-danger">*</span></label>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label for="recipient-name" class="control-label">Keterangan </label>
                                <textarea class="form-control" name="keterangan" id="keterangan_edit" autocomplete="off"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
