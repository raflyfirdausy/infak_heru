                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="active tab-pane" id="profile">
                            <form id="form_profile" action="<?= base_url("master/profile") ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Email <span class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="username" class="form-control" value="<?= $admin->email ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="tanggal_lahir" class="form-control" value="<?= $admin->tanggal_lahir ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Agama <span class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <select required class="form-control select2bs4" name="agama">
...
<script>
    $("#form_profile").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/profile/change_profile") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    $("#form_pass").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/profile/change_password") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
