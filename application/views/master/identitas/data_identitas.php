    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <form id="form_add" action="<?= base_url("master/identitas/proses") ?>" method="post" enctype="multipart/form-data">
                    <div class="card-header">
                        <h3 class="text-center text-bold">Data Identitas Aplikasi</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Nama Pondok Pesantren</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="pondok" class="form-control" placeholder="Nama Pondok Pesantren" value="<?= $identitas->pondok ?>">
                                    </div>
                                </div>                                                              
                                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" onkeyup="validate(this)" name="telp" class="form-control" placeholder="No Telp" value="<?= $identitas->telp ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <img id="imgPreview" src="<?= $identitas->logo ? asset("infak/img/" . $identitas->logo) :  asset("apotek/img/no-img.jpg") ?>" class="col-md-12" alt="">
                                            <div class="form-group">
...
<script>
    ...
    $("#form_add").submit(e => {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('master/identitas/proses') ?>",
            data: formData,
            dataType: 'JSON',
            async: false,
            cache: false,
            ...
            success: function(result) {
                if (result.code == 200) {
                    Swal.fire({
                        ...
                        .then((result) => {
                            window.location.href = "<?= base_url('master/identitas') ?>";
                        })
                } else {
                    Swal.fire(
                        'Gagal',
